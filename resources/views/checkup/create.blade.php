         ...
         <div class="card-body">
            <form method="post" action="{{ route('patient.create') }}" enctype="multipart/form-data">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="inputAddress2">{{ __('sentence.Pulse') }}</label>
               ...
               <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputAddress2">{{ __('sentence.CaseID') }}</label>
                   <input type="text" class="form-control" id="CaseID" name="CaseID">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputAddress">{{ __('sentence.Date') }}<font color="red">*</font></label>
             ...
             <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputEmail4">{{ __('sentence.Heart Rate') }}<font color="red">*</font></label>
                   <input type="text" class="form-control" id="Heart Rate" name="Heart Rate">
                </div>
                <div class="form-group col-md-6">
                   <label for="inputPassword4">{{ __('sentence.Pressure') }}<font color="red">*</font></label>
                   <input type="text" class="form-control" id="Pressure" name="Pressure">
                </div>
             </div>
             <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputEmail4">{{ __('sentence.Oxygen') }}<font color="red">*</font></label>
                   <input type="text" class="form-control" id="Oxygen" name="Oxygen">
                </div>
                <div class="form-group col-md-6">
                   <label for="inputPassword4">{{ __('sentence.Temperature') }}<font color="red">*</font></label>
