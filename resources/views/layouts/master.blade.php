         ...
         <div id="wrapper">
            ...
            {{-- check up section --}}
               ...
               <li class="nav-item">
                  ...
                  <span>{{ __('sentence.Check Up') }}</span>
                  </a>
                  <div id="collapsePatients" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        @can('add patient')
                        <a class="collapse-item" href="{{ route('checkup.create') }}">{{ __('sentence.Cases') }}</a>
                        @endcan
                        @can('view all patients')
                        <a class="collapse-item" href="{{ route('patient.all') }}">{{ __('sentence.Add checkup') }}</a>
                        @endcan
                     </div>
                  </div>
               </li>
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <div class="dropdown shortcut-menu mr-4">
                       ...
                       <div class="dropdown-menu shadow">
                        ...
                        @endif
                        {{-- checkup --}}
                        @if(Auth::user()->can('create checkup'))
                              <a class="dropdown-item" href="{{ route('checkup.create') }}">{{ __('sentence.Check Up') }}</a>
                        @endif
