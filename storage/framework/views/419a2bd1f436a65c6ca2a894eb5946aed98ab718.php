      ...
      <div class="card shadow mb-4">
         ...
         <div class="card-body">
            ...
            <form method="post" action="<?php echo e(route('drug.store')); ?>">
               ...
               <div class="form-group">
                  <label for="exampleInputPassword1"><?php echo e(__('sentence.Price')); ?></label>
                  <input type="number" class="form-control" name="Price" id="Price">
               </div>
               <div class="form-group">
                <label for="exampleInputPassword1"><?php echo e(__('sentence.Stock')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work1\11.22\v4.0\resources\views/drug/create.blade.php ENDPATH**/ ?>