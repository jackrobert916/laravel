         ...
         <div class="card-body">
            <form method="post" action="<?php echo e(route('patient.create')); ?>" enctype="multipart/form-data">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="inputAddress2"><?php echo e(__('sentence.Pulse')); ?></label>
               ...
               <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputAddress2"><?php echo e(__('sentence.CaseID')); ?></label>
                   <input type="text" class="form-control" id="CaseID" name="CaseID">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputAddress"><?php echo e(__('sentence.Date')); ?><font color="red">*</font></label>
             ...
             <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputEmail4"><?php echo e(__('sentence.Heart Rate')); ?><font color="red">*</font></label>
                   <input type="text" class="form-control" id="Heart Rate" name="Heart Rate">
                </div>
                <div class="form-group col-md-6">
                   <label for="inputPassword4"><?php echo e(__('sentence.Pressure')); ?><font color="red">*</font></label>
                   <input type="text" class="form-control" id="Pressure" name="Pressure">
                </div>
             </div>
             <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputEmail4"><?php echo e(__('sentence.Oxygen')); ?><font color="red">*</font></label>
                   <input type="text" class="form-control" id="Oxygen" name="Oxygen">
                </div>
                <div class="form-group col-md-6">
                   <label for="inputPassword4"><?php echo e(__('sentence.Temperature')); ?><font color="red">*</font></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work1\11.22\v4.0\resources\views/checkup/create.blade.php ENDPATH**/ ?>