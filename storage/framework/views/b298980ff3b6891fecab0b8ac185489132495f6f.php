      ...
      <div id="app">
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <!-- Heading -->
               <div class="sidebar-heading">
                  <?php echo e(__('sentence.Check Up')); ?>

               </div>
               <!-- Nav Item - Pages Collapse Menu -->
               <li class="nav-item">
                  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePatients" aria-expanded="true" aria-controls="collapseTwo">
                  <i class="fas fa-fw fa-check"></i>
                  <span><?php echo e(__('sentence.Check Up')); ?></span>
                  </a>
                  <div id="collapsePatients" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add patient')): ?>
                        <a class="collapse-item" href="<?php echo e(route('checkup.create')); ?>"><?php echo e(__('sentence.Cases')); ?></a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all patients')): ?>
                        <a class="collapse-item" href="<?php echo e(route('patient.all')); ?>"><?php echo e(__('sentence.Add checkup')); ?></a>
                        <?php endif; ?>
                     </div>
                  </div>
               </li>
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <div class="dropdown shortcut-menu mr-4">
                       ...
                       <div class="dropdown-menu shadow">
                        ...
                        <?php if(Auth::user()->can('create checkup')): ?>
                              <a class="dropdown-item" href="<?php echo e(route('checkup.create')); ?>"><?php echo e(__('sentence.Check Up')); ?></a>
                        <?php endif; ?>
...
<?php /**PATH E:\work1\11.22\v4.0\resources\views/layouts/master.blade.php ENDPATH**/ ?>